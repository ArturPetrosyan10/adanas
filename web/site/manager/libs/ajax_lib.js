...
function selectRollsCur(NAME_SEARCH, REL_DATA_CONT, BLABLE, SLABLE) {
...

      {
...

        {
          ...
          if (curCount > 0) {
            ...
            document.getElementById('orderListCountContHREF').href = 'http://' + window.location.hostname + '/basket/';
...

        {
          ...
          if (mode == 0) {
            ...
            if ($("#favorite_cont").hasClass("active") === false) {
              ...
              document.getElementById('favorite_cont').href = 'http://' + window.location.hostname + '/wishlist/';

              document.getElementById('favorite_cont_2').href = 'http://' + window.location.hostname + '/wishlist/';
