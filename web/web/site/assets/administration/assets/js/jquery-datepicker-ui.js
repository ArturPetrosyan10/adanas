...
//>>css.theme: ../../themes/base/theme.css
	...
	function Datepicker() {
		...
		this.regional[ "" ] = { // Default regional settings
			...
			monthNamesShort: [ "Հուն", "Փետ", "Մար", "Ապր", "Մայ", "Հուն", "Հուլ", "Օգս", "Սեպ", "Հոկ", "Նոյ", "Դեկ" ], // For formatting

			dayNames: [ "Կիրակի", "Երկուշաբթի", "Երեքշաբթի", "Չորեքշաբթի", "Հինգշաբթի", "Ուրբաթ", "Շաբաթ" ], // For formatting

			dayNamesShort: [ "Կիր", "Երկ", "Երք", "Չոր", "Հին", "Ուրբ", "Շաբ" ], // For formatting

			dayNamesMin: [ "Կի","Եր","Եր","Չո","Հի","Ուր","Շա" ], // Column headings for days starting at Sunday
