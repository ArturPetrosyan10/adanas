...
function ResCarouselSlide(e) {
    ...
    !isNaN(dataInterval) && $(e).addClass("ResHover") && setInterval(function() {
        !(this.parent().hasClass("ResHovered")) && ResCarousel(this);
    }, +(dataInterval));
}
...
function ResCarousel(Btn) {
    ...
    parent.attr("data-animator") == "" && resCarouselAnimator(itemsDiv, cond ? 0 : 1, currentSlide + 1, currentSlide + dataItm, itemSpeed, (slide * itemWidth));
    if (!isNaN(itemLoad)) {
