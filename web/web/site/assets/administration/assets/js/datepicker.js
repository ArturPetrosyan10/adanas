...
var DEFAULTS = {
  ...
  daysMin: ['Կի', 'Եր', 'Եր', 'Չո', 'Հի', 'Ուր', 'Շբ'],



  // Months' name

  months: ['Հունվար', 'Փետրվար', 'Մարտ', 'Ապրիլ', 'Մայիս', 'Հունիս', 'Հուլիս', 'Ոգոստոս', 'Սեպտեմբեր', 'Հոկտեմբեր', 'Նոյեմբեր', 'Դեկտեմբեր'],



  // Shorter months' name

  monthsShort: ['Հուն', 'Փետ', 'Մար', 'Ապր', 'Մայ', 'Հուն', 'Հուլ', 'Ոգս', 'Սեպ', 'Հոկ', 'Նոյ', 'Դեկ'],
