    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/manager/orders"><i class="menu-icon fa fa-shopping-cart"></i>Պատվերներ</a>
                </li>
                <li>
                    <a href="/manager/products"><i class="menu-icon fa fa-cube"></i>Ապրանքներ</a>
                </li>
                <li>
                    <a href="/manager/discounts"><i class="menu-icon fa fa-percent"></i>Զեղչեր</a>
                </li>
                <li>
                    <a href="/manager/workers"><i class="menu-icon fa fa-users"></i>Աշխատակիցներ</a>
                </li>
                <li>
                    <a href="/manager/partners"><i class="menu-icon fa fa-user"></i>Գործընկերներ</a>
                </li>
                <li>
                    <a href="/manager/stores"><i class="menu-icon fa fa-sitemap"></i>Խանութներ</a>
                </li>
                <li>
                    <a href="/manager/managment"><i class="menu-icon fa fa-magic"></i>Կառավարում</a>
                </li>
                <li>
                    <a href="/manager/settings"><i class="menu-icon fa fa-cogs"></i>Կարգավորումներ</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
            ...
            <div class="header-menu">
                ...
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <b class="user-avatar rounded-circle"><?php echo  Yii::$app->fsUser->identity->name; ?></b>
                    </a>
                    <div class="user-menu dropdown-menu">
                        ...
                        <a class="nav-link" href="/manager/logout"><i class="fa fa-power -off"></i>Դուրս գալ</a>
                    </div>
                </div>
    ...
    window.onload = function(){
        ...
        jQuery('.sortable').sortable({
            ...
            update: function (event, ui) {
                ...
                jQuery.ajax('/manager/update-order', {
        ...
        jQuery('.customer').on('change',function () {
            ...
            jQuery('.customer').each(function () {
                if (jQuery(this).is(':checked')) {
                    items_val += jQuery(this).val() + ',';
                }
            });
            jQuery('#items').val(items_val);
        });
    }
</script>
