                            ...
                            <table class="table table-responsive">
                                ...
                                <?php if(!empty($discounts)){ ?>
                                    <?php foreach ($discounts as $discount => $discount_val){ ?>
                                        <tr>
                                            <td><?php echo $user->legal_name;?></td>
                                            <td><?php echo $discount_val->name;?></td>
                                            <td><?php echo $discount_val->discount_price;?></td>
                                            <td><time><?php echo $discount_val->start_date;?></time></td>
                                            <td><time><?php echo $discount_val->end_date;?></time></td>
                                    ...
                                    <?php foreach ($discounts as $discount => $discount_val){ ?>
                                        <tr>
                                            <td>
                                                ...
                                                <p><?= $GLOBALS['text']["__beginning__"] ?> <time style="float:right;"><?php echo $discount_val->start_date;?></time>
                                                <p><?= $GLOBALS['text']["__end__"] ?> <time style="float:right;"><?php echo $discount_val->end_date;?></time></p>
                                                <p><?= $GLOBALS['text']["__status__"] ?> <span style="float:right;"><?php switch ($discount_val->discount_status){
                                                            case 0:
                                                                echo $GLOBALS['text']["__pending__"] ;
                                                                break;
                                                            case 1:
