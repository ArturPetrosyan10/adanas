                                                    ...
                                                    <tr data-id="<?php echo $blog->id;?>">
                                                        ...
                                                        <td scope="col">
                                                            <?php if (!empty($blog->img)) { ?>
                                                                <img src="/<?php echo $blog->img; ?>" height="60"
                                                                     alt="">
                                                            <?php } ?></td>
                        ...
                        <div class="custom-tab">
                            ...
                            <select name="FsBlogs[category_id]" class="form-control">
                                <?php if(!empty($categories)){ ?>
                                    <?php foreach ($categories as $category => $category_val){ ?>
                            ...
                            <div class="tab-content" id="nav-tabContent"><br>
                                <div class="tab-pane fade active show" id="custom-nav-product-am" role="tabpanel" aria-labelledby="custom-nav-product-am-tab">
                                    <div class="form-group ">
                                        <span>Անուն</span>
                                        <input type="text" name="FsBlogs[page_name_am]" required placeholder="Անուն" class="form-control">
                                        <span>Վերնագիր</span>
                                        <input type="text" name="FsBlogs[page_title_am]"   placeholder="Վերնագիր" class="form-control">
                                        <span>Բանալի Բառեր</span>
                                        <textarea name="FsBlogs[page_keywords_am]" class="form-control" placeholder="Բանալի Բառեր" rows="3"></textarea>
                                        <span>Պարունակություն</span>
                                        <textarea name="FsBlogs[page_content_am]" class="form-control" id="editor_am" placeholder="Պարունակություն" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="custom-nav-product-ru" role="tabpanel" aria-labelledby="custom-nav-product-ru-tab">
                                    <div class="form-group">
                                        <span>Անուն</span>
                                        <input type="text" name="FsBlogs[page_name_ru]"   placeholder="Անուն" class="form-control">
                                        <span>Վերնագիր</span>
                                        <input type="text" name="FsBlogs[page_title_ru]"   placeholder="Վերնագիր" class="form-control">
                                        <span>Բանալի Բառեր</span>
                                        <textarea name="FsBlogs[page_keywords_ru]" class="form-control" placeholder="Բանալի Բառեր" rows="3"></textarea>
                                        <span>Պարունակություն</span>
                                        <textarea name="FsBlogs[page_content_ru]" class="form-control"  id="editor_ru" placeholder="Պարունակություն" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="custom-nav-product-en" role="tabpanel" aria-labelledby="custom-nav-product-en-tab">
                                    <div class="form-group">
                                        <span>Անուն</span>
                                        <input type="text" name="FsBlogs[page_name_en]"   placeholder="Անուն" class="form-control">
                                        <span>Վերնագիր</span>
                                        <input type="text" name="FsBlogs[page_title_en]"   placeholder="Վերնագիր" class="form-control">
                                        <span>Բանալի Բառեր</span>
                                        <textarea name="FsBlogs[page_keywords_en]" class="form-control" placeholder="Բանալի Բառեր" rows="3"></textarea>
                                        <span>Պարունակություն</span>
                                        <textarea name="FsBlogs[page_content_en]" class="form-control"  id="editor_en" placeholder="Պարունակություն" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
