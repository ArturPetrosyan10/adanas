    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addnew">Պատճենել պաստառ (<?php echo $banner->title_am;?>)</h5>
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="FsBanners[image]" value="<?php echo $banner->image;?>">
                        <span>նկար (1920X550)</span>
                        <input type="file" name="img" >
                        <br>
                        <br>
                        <img src="/<?php echo $banner->image_mobile;?>" alt="" height="55">
                        <input type="hidden" name="FsBanners[image_mobile]" value="<?php echo $banner->image_mobile;?>">
