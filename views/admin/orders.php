                    ...
                    <div class="card-body">
                        <h4 class="box-title">Պատվերներ
                            ...
                            <?php if(!isset($_GET['search'])){ ?>
                                <a href="#" data-toggle="modal" data-target="#search" class="btn btn-succ fl">
                                    <i class="fa fa-search"></i>
                                </a>
                            <?php } else { ?>
                                <a href="/admin/orders" class="btn btn-succ fl" style="padding:5px;"><img src="/web/images/searchclose.png" alt="" width="25"></a>
                            <?php } ?>
                        </h4>
                    </div>
                    <div class="card-body--">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination">
                                                    ...
                                                    <?php if(isset($_GET['page']) && intval($_GET['page'] )>0){ ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="/admin/orders?page=<?php echo intval($_GET['page'])-1;?>" aria-label="Previous">
                                                    ...
                                                    for ($i = 1; $i <= $pages; $i++){
                                                        if( $i == (intval($_GET['page'])+2) || $i == (intval($_GET['page'])+3) || $i == (intval($_GET['page'])-1)  ||  $i == (intval($_GET['page'])) ||  $i == intval($_GET['page'])+1) {
                                                            ...
                                                            echo '<li class="page-item '.$class.'"><a class="page-link" href="/admin/orders?page=' . ($i-1).'">' . $i.'</a></li>';
                                                        }
                                                    } ?>
                                                    <?php if(isset($_GET['page']) && (intval($_GET['page'] )+1) < $pages){ ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="/admin/orders?page=<?php echo (intval($_GET['page'] )+1);?>" aria-label="Next">
                                                    ...
                                                    <?php } ?>
                                                    <li>
                                                    <li class="page-item"><a class="page-link" href="/admin/orders?page=all">Տեսնել ամբողջը</a></li>
                                                    </li>
                                                </ul>
                                            </nav>
                                        <?php } ?>
                    ...
                    <form action="" method="get" enctype="multipart/form-data">
                        <div class="row form-group">
                            ...
                            <div class="col col-md-12">
                                ...
                                <div class="row">
                                    <?php  if(!Yii::$app->user->identity->company_id){ ?>
                                    <div class="col-sm-2">
