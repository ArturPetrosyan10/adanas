  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addnew">Պատճենել Կատեգորիա (<?php echo $category->name;?>)</h5>
          ...
          <div class="custom-tab">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active show" id="custom-nav-home-tab" data-toggle="tab" href="#custom-nav-home" role="tab" aria-controls="custom-nav-am" aria-selected="true">Հայ</a>
                        <a class="nav-item nav-link" id="custom-nav-profile-tab" data-toggle="tab" href="#custom-nav-profile" role="tab" aria-controls="custom-nav-ru" aria-selected="false">Ռուս</a>
                        <a class="nav-item nav-link " id="custom-nav-contact-tab" data-toggle="tab" href="#custom-nav-contact" role="tab" aria-controls="custom-nav-en" aria-selected="false">Անգլ</a>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent_edite">
                    <br>
                    <div class="tab-pane fade active show" id="custom-nav-am" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                        <div class="form-group ">
                    ...
                    <div class="tab-pane fade" id="custom-nav-ru" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                        <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="custom-nav-en" role="tabpanel" aria-labelledby="custom-nav-contact-tab">
                        <div class="form-group">
