<?php use app\models\FsParamToCategory;use app\models\FsCategories;?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addnew">Պատճենել ապրանք (<?php echo $product->name;?>)</h5>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="collapse" id="showProps__">
                            ...
                            echo  Yii::$app->view->renderFile('@app/views/admin/get-param.php',['params'=>$params,'paramsToCategory'=>$paramsToCategory,'product'=>$product, 'paramsOrigin' => $paramsOrigin]);?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="atg" placeholder="ATG" value="<?php echo $product->atg;?>" class="form-control">
                            ...
                            <input type="text" name="price" value="<?php echo $product->price;?>" placeholder="Արժեք" class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="row" style="margin:10px 0px;">
                                ...
                                <?php if(!empty($product->image)){?>
                                    ...
                                    <?php foreach ($images as $img){ ?>
                                        <span style="position:relative;display:inline-block;width:60px;height:50px;">
                                            <input type="hidden" name="old_prod[]" value="<?php echo $img;?>">
                                            <img src="/<?php echo $img;?>" height="45" alt="" style="border:1px solid lightgray;margin:5px;">
                            ...
                            <div class="col-sm-6" style="color: #878787;padding-left:0px;">Վիդեո  <input type="file" name="video">
                                <?php if(!empty($product->video)){?>
                                    <input type="hidden" name="old_video" value="<?php echo $product->video;?>">
                   ...
                   <span>
                    ...
                    <div class="custom-tab">
                        ...
                        <div class="tab-content" id="nav-tabContent"><br>
                            ...
                            <div class="tab-pane fade" id="custom-nav-product-ru-edite" role="tabpanel" aria-labelledby="custom-nav-product-ru-edite-tab">
                                <div class="form-group">
                                    <input type="text" name="name_ru" value="<?php echo $product->name_ru;?>" placeholder="Անուն" class="form-control">
                                    <textarea name="description_ru" class="form-control" placeholder="Նկարագիր" rows="3"><?php echo $product->description_ru;?></textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="custom-nav-product-en-edite" role="tabpanel" aria-labelledby="custom-nav-product-en-edite-tab">
                                <div class="form-group">
                                    <input type="text" name="name_en" placeholder="Անուն" class="form-control" value="<?php echo $product->name_en;?>">
                                    <textarea name="description_en" placeholder="Նկարագիր" class="form-control" rows="3"><?php echo $product->description_en;?></textarea>
                                </div>
                            </div>
                        </div>
