    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addnew">Պատճենել  (<?php echo $blog->page_name_am;?>)</h5>
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <select name="FsBlogs[category_id]" class="form-control">
                        <?php if(!empty($categories)){ ?>
                            <?php foreach ($categories as $category => $category_val){ $state_ = ''; ?>
                                <?php if($category_val->id == $blog->category_id){ $state_ = 'selected'; } ?>
                                <option <?=$state_?> value="<?=$category_val->id?>"><?=$category_val->name?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
                    <br>
                        ...
                        <div class="tab-content" id="nav-tabContent"><br>
                            <div class="tab-pane fade active show" id="custom-nav-page-am" role="tabpanel" aria-labelledby="custom-nav-page-am-tab">
                                <div class="form-group ">
                                    <span>Անուն</span>
                                    <input type="text" name="FsPages[page_name_am]" value="<?php echo $blog->page_name_am;?>" required placeholder="Անուն" class="form-control">
                                    <span>Վերնագիր</span>
                                    <input type="text" name="FsPages[page_title_am]"  value="<?php echo $blog->page_title_am;?>"  placeholder="Վերնագիր" class="form-control">
                                    <span>Բանալի Բառեր</span>
                                    <textarea name="FsPages[page_keywords_am]" class="form-control" placeholder="Բանալի Բառեր" rows="3"><?php echo $blog->page_keywords_am;?></textarea>
                                    <span>Պարունակություն</span>
                                    <textarea name="FsPages[page_content_am]" class="form-control" id="editor_am_p" placeholder="Պարունակություն" rows="3"><?php echo $blog->page_content_am;?></textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="custom-nav-page-ru" role="tabpanel" aria-labelledby="custom-nav-page-ru-tab">
                                <div class="form-group">
                                    <span>Անուն</span>
                                    <input type="text" name="FsPages[page_name_ru]"  value="<?php echo $blog->page_name_ru;?>"  placeholder="Անուն" class="form-control">
                                    <span>Վերնագիր</span>
                                    <input type="text" name="FsPages[page_title_ru]"  value="<?php echo $blog->page_title_ru;?>"  placeholder="Վերնագիր" class="form-control">
                                    <span>Բանալի Բառեր</span>
                                    <textarea name="FsPages[page_keywords_ru]" class="form-control" placeholder="Բանալի Բառեր" rows="3"><?php echo $blog->page_keywords_ru;?></textarea>
                                    <span>Պարունակություն</span>
                                    <textarea name="FsPages[page_content_ru]" class="form-control"  id="editor_ru_p" placeholder="Պարունակություն" rows="3"><?php echo $blog->page_content_ru;?></textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="custom-nav-page-en" role="tabpanel" aria-labelledby="custom-nav-page-en-tab">
                                <div class="form-group">
                                    <span>Անուն</span>
                                    <input type="text" name="FsPages[page_name_en]"  value="<?php echo $blog->page_name_en;?>"  placeholder="Անուն" class="form-control">
                                    <span>Վերնագիր</span>
                                    <input type="text" name="FsPages[page_title_en]"  value="<?php echo $blog->page_title_en;?>"  placeholder="Վերնագիր" class="form-control">
                                    <span>Բանալի Բառեր</span>
                                    <textarea name="FsPages[page_keywords_en]" class="form-control" placeholder="Բանալի Բառեր" rows="3"><?php echo $blog->page_keywords_en;?></textarea>
                                    <span>Պարունակություն</span>
                                    <textarea name="FsPages[page_content_en]" class="form-control"  id="editor_en_p" placeholder="Պարունակություն" rows="3"><?php echo $blog->page_content_en;?></textarea>
                                </div>
                            </div>
                        </div>
