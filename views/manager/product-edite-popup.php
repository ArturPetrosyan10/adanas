                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="atg" placeholder="ATG" value="<?php echo $product->atg;?>" class="form-control atg_">
                   ...
                   <span>
                    ...
                    <button type="button" class="btn btn-succ" name="edite" value="true">Գրանցել</button>
...
<script>
    jQuery('#edite-product').modal('show');
     let id = jQuery('#category_edite').val();        
