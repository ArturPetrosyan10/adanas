...
<div class="products">
                                                ...
                                                <div class="col-sm-6">
                                                    <form class="row" enctype="multipart/form-data" method="post">
                                                       ...
                                                       <div class="col-sm-5">
                                                         ...
                                                         <div class="col-sm-2">
                                                        <button type="submit" class="btn btn-succ" name="uploads">Ներբեռնել</button>
                                                         </div>
                                                    </form>
                                                </div>
                                                <div class="col-sm-3">
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="/manager/products" class="btn btn-succ fl" style="padding:5px;"><img src="/web/images/searchclose.png" alt="" width="25"></a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination">
                                                            ...
                                                            <li class="page-item">
                                                                <a class="page-link" href="/manager/products?page=<?php echo intval($_GET['page'])-1;?>" aria-label="Previous">
                                                            ...
                                                            for ($i = 1; $i <= $pages; $i++){
                                                                if( $i == (intval($_GET['page'])+2) || $i == (intval($_GET['page'])+3) || $i == (intval($_GET['page'])-1)  ||  $i == (intval($_GET['page'])) ||  $i == intval($_GET['page'])+1) {
                                                                    ...
                                                                    echo '<li class="page-item '.$class.'"><a class="page-link" href="/manager/products?page=' . ($i-1).'">' . $i.'</a></li>';
                                                                }
                                                            } ?>
                                                            <?php if(isset($_GET['page']) && (intval($_GET['page'] )+1) < $pages){ ?>
                                                            <li class="page-item">
                                                                <a class="page-link" href="/manager/products?page=<?php echo (intval($_GET['page'] )+1);?>" aria-label="Next">
                                                            ...
                                                            <?php } ?>
                                                            <li>
                                                               <li class="page-item"><a class="page-link" href="/manager/products?page=all">Տեսնել ամբողջը</a></li>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                    <?php } ?>
    ...
    function display_list($nested_categories, $type = 'sortable', $level = 0, $ch = false)
    {
          foreach($nested_categories as $nested){
            ...
            if( ! empty($nested['child'])){$list .= display_list($nested['child'],$type,$level+1,$ch);}
          }
          return $list;
    }
?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="hidden" name="<?= $this->renderDynamic('return Yii::$app->request->csrfParam;'); ?>" value="<?= $this->renderDynamic('return Yii::$app->request->csrfToken;'); ?>" />
          ...
          <div class="custom-tab">
             ...
             <button type="button" class="btn btn-succ" name="add" value="true">Գրանցել</button>
