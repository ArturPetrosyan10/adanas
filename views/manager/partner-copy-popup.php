    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addnew">Պատճենել հաճախորդ ( գործընկեր ՝ <?php echo $partner->legal_name;?>) </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data" id="Partners_">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="FsUsers[company_hvhh]" value="<?php echo $partner->company_hvhh;?>" placeholder="Կազմակերպության ՀՎՀՀ" class="form-control">
                            ...
                            <input type="text" name="FsUsers[holding_hvhh]" value="<?php echo $partner->holding_hvhh;?>" placeholder="Հոլդինգի ՀՎՀՀ" class="form-control">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="FsUsers[email]" value="<?php echo $partner->email;?>" placeholder="Էլեկտրոնային հասցե *" class="form-control">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="file" name="logo">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"  <?php if($partner->is_buyer){ echo 'checked';}?> name="FsUsers[is_bayer]" value="1" id="flexCheckChecked" >
                            ...
                            <input type="text" name="FsUsers[phone]" value="<?php echo $partner->phone;?>" placeholder="Հեռախոսահամար *" class="form-control">
                            ...
                            <input type="text" name="FsUsers[password]" value="" placeholder="Գաղտնաբառ *" required class="form-control">
                        </div>
