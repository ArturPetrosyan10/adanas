...
<!--                                <button class="btn btn-sm btn-default" style="margin-left:30px;" id="copyProduct" ><i class="fa fa-copy"></i></button>-->
                                <button class="btn btn-sm btn-default" id="editeStoreProduct"><i class="fa fa-pencil"></i></button>
                            ...
                            <?php } else { ?>
                                <a href="/store/products" class="btn btn-succ fl" style="padding:5px;"><img src="/web/images/searchclose.png" alt="" width="25"></a>
                            <?php } ?>
                        </h4>
                    </div>
                    <div class="card-body--">
                                                ...
                                                <?php if(!empty($products)){ ?>
                                                    <?php foreach ($products as $product){ ?>
                                                        <tr data-id="<?php echo $product->id;?>">
                                                            ...
                                                            <td scope="col">
                                                                <?php if(!empty($product->image->name)){?>
                                                                    <img src="/<?php echo $product->image->name;?>" height="40" alt="">
                                                                <?php } ?>
                                                            </td>
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination">
                                                    ...
                                                    <?php if(isset($_GET['page']) && intval($_GET['page'] )>0){ ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="/store/products?page=<?php echo intval($_GET['page'])-1;?>" aria-label="Previous">
                                                    ...
                                                    for ($i = 1; $i <= $pages; $i++){
                                                        if( $i == (intval($_GET['page'])+2) || $i == (intval($_GET['page'])+3) || $i == (intval($_GET['page'])-1)  ||  $i == (intval($_GET['page'])) ||  $i == intval($_GET['page'])+1) {
                                                            ...
                                                            echo '<li class="page-item '.$class.'"><a class="page-link" href="/store/products?page=' . ($i-1).'">' . $i.'</a></li>';
                                                        }
                                                    } ?>
                                                    <?php if(isset($_GET['page']) && (intval($_GET['page'] )+1) < $pages){ ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="/store/products?page=<?php echo (intval($_GET['page'] )+1);?>" aria-label="Next">
                                                    ...
                                                    <?php } ?>
                                                    <li>
                                                    <li class="page-item"><a class="page-link" href="/store/products?page=all">Տեսնել ամբողջը</a></li>
                                                    </li>
                                                </ul>
                                            </nav>
                                        <?php } ?>
