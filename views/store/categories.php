    ...
    if($type == 'sortable'){
        ...
        foreach($nested_categories as $nested){
            ...
            if(! empty($nested['child'])){
                $list .=  '<span class="showChailds key'.$nested['id'].'"><i class="fa fa-chevron-down"></i></span>';
            }
            $list .= '</b>';
            ...
            if( ! empty($nested['child'])){
                $list .= display_list($nested['child']);
            } else {
                $list .= '<ul class="sortable list-unstyled"><li><small>empty</small></li></ul></li>';
            }
        }
        $list .= '</ul>';
    } else {
